...
| --- | --- | --- | --- |
| backup, restore, and recovery verification | recovery objectives, backup validation, restore drills, and what makes rollback or restore realistic | [Lesson 08](08-operational-engineering-and-release-safety.md), [Operations Track](../operations/README.md), [SQL Server infra notes](../../infra/sqlserver/README.md) | [Senior 006](../../src/exercises/Senior/006-release-readiness-and-rollback-gates/README.md) as the nearest release-safety and gate-design drill |
| scheduling, jobs, and operational automation | what belongs in scheduled SQL work, how to reason about job safety, and how background processing changes operational risk | [Repository Architecture](../../README.md#initial-architecture), [Operations Track](../operations/README.md), [SqlAcademy.Worker](../../src/apps/SqlAcademy.Worker) | currently reference-driven; use the release and delivery packs as adjacent operational context |
...
This extension track now exists as a routed specialization guide, but it does not yet claim fully built hands-on packs for backup and restore, SQL Server Agent, HA or DR, security administration, or CDC.

Those deeper labs can expand later without changing the main academy route.
