...
| 5 | [Lesson 06 follow-up](06-indexing-execution-plans-and-parameter-sensitivity.md) | [Advanced 004](../../src/exercises/Advanced/004-query-store-and-regression-triage/README.md) | guided lab | persisted query history, Query Store, and regression triage for tagged workloads |
...
- Lesson 06 now has [Advanced 004](../../src/exercises/Advanced/004-query-store-and-regression-triage/README.md) as the persisted regression-history follow-up for Query Store reasoning.
