...
| blocking, deadlocks, and concurrency response | [Lesson 05](../learning/05-transactions-blocking-and-deadlocks.md), [Phase 4](../phases/phase-4-transactions-and-concurrency.md), [Operations Track](README.md) | [DeadlockReproductionTests](../../tests/SqlAcademy.PerformanceTests/DeadlockReproductionTests.cs), [OrdersController](../../src/apps/SqlAcademy.Api/Controllers/V1/OrdersController.cs), [OrderConfiguration](../../src/libs/SqlAcademy.Persistence/Database/Configurations/OrderConfiguration.cs) | [Senior 001](../../src/exercises/Senior/001-concurrency-blocking-and-deadlocks/README.md) | blaming application code for every timeout without lock or wait evidence |
...
- need to reproduce or reason about blocking and deadlocks: [Senior 001](../../src/exercises/Senior/001-concurrency-blocking-and-deadlocks/README.md) and [DeadlockReproductionTests](../../tests/SqlAcademy.PerformanceTests/DeadlockReproductionTests.cs)
